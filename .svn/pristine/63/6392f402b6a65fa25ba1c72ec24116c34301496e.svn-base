...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="orderDetail" action="${ctx}/orderdetail/orderDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					<td class="width-15 active"><label class="pull-right">订单：</label></td>
					<td class="width-35">
					...
					<td class="width-35">
						<form:input path="xhGoods.id" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
