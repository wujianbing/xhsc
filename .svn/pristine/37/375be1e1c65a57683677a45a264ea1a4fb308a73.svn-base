...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="recAddr" action="${ctx}/recaddress/recAddr/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="recUser" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">收件人电话：</label></td>
					<td class="width-35">
						<form:input path="recPhone" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
