...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="xhOrder" action="${ctx}/xhorder/xhOrder/treated" method="post" class="form-inline">
		...
		<c:forEach items="${page.list}" var="xhOrder">
			<tr>
				...
				<td>
					...
					<a href="${ctx}/xhorder/xhOrder/deliverOrder?id=${xhOrder.id}"  class="btn btn-danger btn-xs"><i class="fa fa-edit"></i>发货</a>
					<%-- <shiro:hasPermission name="xhorder:xhOrder:edit">
