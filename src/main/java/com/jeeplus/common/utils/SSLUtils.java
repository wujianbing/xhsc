...
public class SSLUtils {
	public static String SSLCERT_PATH="E:/apache-tomcat-for-xhpt/webapps/ROOT/apiclient_cert.p12";//证书的路径
	public static String SSLCERT_PASSWORD=PayUtils.mch_id;//证书的密籍
