...
public class DateUtils {
    ...
    public static final String DATE_TIME_PATTERNS = "yyyyMMddHHmmss";
    public static final String DATE_TIME_PATTE = "yyyyMMdd";
    /**
     * 日期相加减天数
     ...
     * @throws ParseException 
     */
    public static int dateBetween1(Date startDate, Date endDate) throws ParseException {
        Date dateStart = dateParse(dateFormat(startDate, DATE_PATTERN), DATE_PATTERN);
        Date dateEnd = dateParse(dateFormat(endDate, DATE_PATTERN), DATE_PATTERN);
        return (int) ((dateEnd.getTime() - dateStart.getTime())/1000/60/60/24); 
    }
    
    public static Long dateBetween(Date startDate, Date endDate) throws ParseException {
        ...
        return (Long) ((dateEnd.getTime() - dateStart.getTime()))/1000; 
    }
    /**
    ...
    public static int dateBetweenIncludeToday(Date startDate, Date endDate) throws ParseException {  
        return dateBetween1(startDate, endDate) + 1;
    }
