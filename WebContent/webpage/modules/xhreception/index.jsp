		...
		<div id="slideBox" class="slideBox">
			<div class="bd">
				<ul>
					...
					<li>
						<a class="pic" href="${bannerList.url}"><img src="${bannerList.uploadFile.relaPath}" /></a>
			...
			<div class="bmonth">
				...
				<div class="flwgd">
					<ul>
						...
						<li>
							<a href="monthDetail?id=${xhMonthbuy.id}&gid=${xhMonthbuy.xhGoods.id}">
							...
							<div class="flwbuy"><img src="static/xhreception/images/adbuy.png"/></div>
							</a>
						</li>
						</c:forEach>
						<!-- <li>
			...
			<div class="bmonth ptjs">
				...
				<div class="flwgd">
					<ul>
						...
						<li>
							<a href="groupDetail?id=${xhGroups.id}">
