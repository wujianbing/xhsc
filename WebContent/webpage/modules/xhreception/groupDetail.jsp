...
<body>
	...
	<section>
		...
		<p class="price">
			￥<span>${xhGroup.lPrice}-${xhGroup.maxPrice}</span><span>${xhGroup.maxNum}人拼团价</span><span>下单送<m>${xhGroup.xhGoods.integral}</m>积分</span>
		</p>
		<p class="yprice">
		...
		<div class="pthb">
			...
			<ul>
				...
				<li><img src="static/xhreception/images/2.png" alt="" />
					<p>
						<span class="pname">${xhBuyers.xhUser.username}</span><br /> 还差<span class="pnum">${xhGroup.maxNum-xhBuyers.hasNum}</span>人成团，<span
