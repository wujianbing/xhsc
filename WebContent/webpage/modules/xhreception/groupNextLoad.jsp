...
<html>
	...
	<!-- <script type="text/javascript">
		$(function(){
			...
			$(".tbbox").find("ul li").eq(0).click(function(){
				...
				$(this).children("img").attr("src","images/ps2.png");
				$(this).siblings("li").children("img").attr("src","images/zt1.png");
			...
			$(".tbbox").find("ul li").eq(1).click(function(){
				...
				/*$(this).addClass("select");
				$(this).siblings("li").removeClass("select");
				$(this).children("img").attr("src","images/zt2.png");
				$(this).siblings("li").children("img").attr("src","images/ps1.png");
	...
	<body>
		 <!--拼团流程-->
		<div class="pttop">
			<div class="pt1"><img src="static/xhreception/images/1.png"/><p>1.选择商品开团/参团</p></div>
			<div class="pt2"><img src="static/xhreception/images/3.png"/><p>2.邀请好友参团</p></div>
			<div class="pt3"><img src="static/xhreception/images/2.png"/><p>3.人满成团</p></div>
		</div> 
		<!--选择收货方式-->
		<div class="top">
			<div class="tbbox">
				<ul>
					...
					<!-- <li class="ztway"><img src="static/xhreception/images/zt1.png"/>到店自提</li> -->
				</ul>
			</div>
			<div class="tbcont">
				<div class="box">
