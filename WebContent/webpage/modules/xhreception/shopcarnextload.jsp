	...
	<body>
		...
		<div class="gdinfo">
			...
			<div class="gdlist">
				...
				<div class="det">
					<h5>${xhShopcars.xhGoods.name}</h5>
					<p>${xhShopcars.remarks}</p>
					<p class="ppri"><sm>￥</sm><span class="price">${xhShopcars.price}</span><span class="num">&times;${xhShopcars.num}</span></p>
				</div>
			</div>
			</c:forEach>
			<!-- <div class="gdlist">
		...
		<!--商品金额、运费-->
		<p class="spje">商品金额<span>￥<m>${amount}</m></span></p>
		 <p class="yf">运费<span>+￥<m>0.00</m></span></p>
		<p class="hj">合计：<b>￥<m>${amount}</m></b></p>
		<!--bottom-->
		<div class="bottom">
			<p>合计：<b>￥<m id="amount">${amount}</m></b></p>
