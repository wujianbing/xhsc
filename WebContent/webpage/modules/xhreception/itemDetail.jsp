...
<html>
	...
	<body>
		...
		<section>
			...
			<p class="price">￥<span>${xhGoods.price}-${xhGoods.maxPrice}</span><span>下单送<m>${xhGoods.integral}</m>积分</span></p>
			<p class="yunf">运费：<span>免运费</span></p>
			<!-- <p class="select">选择：规格参数</p> -->
			<div class="kefu"><a href="#"><span style="color:#9D9D9D;">点击扫码添加店主微信咨询:</span><span style="color:red;">mub0699520</span></a></div>
			<p class="select" style="color:#9D9D9D;">商品描述</p>
