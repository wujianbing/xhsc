			...
			<form action="">
				<ul>
					...
					<li>
						...
						<!-- <a href="#"><img src="static/xhreception/images/edit.png"/></a> --> <button class="delAddr" aid="${recAddres.id}"><img src="static/xhreception/images/del.png"></button> 
					</li>
					</c:forEach>
		...
		<div class="box2">
			...
			<form action="saveAddr" method="get" id="add">
				...
				<div class="close">&times;</div></li>
					<input hidden="hidden" name="recid">
				...
				<input type="button" value="保存地址" onclick="add()" /> 
			</form>
			</div>
