...
<button id="btnImport" class="btn btn-white btn-sm " onclick="writeData()" data-toggle="tooltip" data-placement="left" title="写入U8"><i class="fa fa-file-excel-o"></i> 写入U8</button>
...
$(document).ready(function() {
	...
	top.layer.confirm('确认要写入选中的除数据吗?', {icon: 3, title:'系统提示'}, function(index){
